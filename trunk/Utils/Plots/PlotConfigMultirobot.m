function PlotConfigMultirobot(varargin)

% PlotConfigMultirobot(varargin)
% The script plots the current config
% It can either take struct parameters:
%       PlotConfigMultirobot(Plot,Config,Graph);
% or nonstruct parameters
%       PlotConfigMultirobot(plot_mesurements,config,factors,id2config,poseDim,color1,color2);
%
% Links from different robots has different colours
% Author: Viorela Ila
